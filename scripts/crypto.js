...
function createRequestBinding(key, data) {
    ...
    const tagBits = sjcl.codec.hex.toBits("686173685f726571756573745f62696e64696e67");
    ...
    console.log("mac bytes: " + digestBytes);
    return digestBytes;
}
...
function sec1DecodePoint(p) {
    ...
    if (sec1Bytes[0] != 0x04) {
        console.log("attempted sec1DecodePoint with incorrect tag", p);
        return null;
    }
