 ...
 */
export function verifyConfiguration(publicKey, config, signature) {
 ...
 * @return {boolean}
 */
export function verifyProof(proofObj, tokens, signatures, commitments, prngName) {
 ...
 */
export function deriveKey(N, token) {
...
export function createRequestBinding(key, data) {
